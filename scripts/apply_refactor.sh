...
echo " - misp.example.com / misp.lan"
echo " - opencti.example.com / opencti.lan"
echo " - openaev.example.com / openaev.lan"
echo " - thehive.example.com / thehive.lan"
echo " - cortex.example.com / cortex.lan"
echo " - vaultwarden.example.com / vaultwarden.lan"
