...
INSERT INTO monitor (id, name, type, url, maxretries, active, interval, retry_interval, user_id, ignore_tls) VALUES (27, '[Default VLAN (1] Vaultwarden (Debian)', 'http', 'http://<VAULTWARDEN_IP>:80', 3, 1, 60, 60, 1, 1);
