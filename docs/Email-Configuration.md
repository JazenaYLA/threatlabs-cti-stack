...
|---------------|------------------------|---------|
| `*@threatresearcher.com` | `threatresearcher@agentmail.to` | AI Triage for the `.com` domain |
| `*@threatresearcher.net` | `threatlabs@agentmail.to` | AI Triage for the `.net` domain |
